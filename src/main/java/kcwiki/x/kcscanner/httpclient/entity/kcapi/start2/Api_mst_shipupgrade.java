...
public class Api_mst_shipupgrade
{
    ...
    public boolean equals(Object obj) {
        ...
        boolean isEqual = EqualsBuilder.reflectionEquals(this, obj);
        return isEqual;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 79 * hash + Objects.hashCode(this.api_upgrade_type);
        hash = 79 * hash + Objects.hashCode(this.api_upgrade_level);
        hash = 79 * hash + Objects.hashCode(this.api_drawing_count);
        hash = 79 * hash + Objects.hashCode(this.api_catapult_count);
        hash = 79 * hash + Objects.hashCode(this.api_report_count);
        hash = 79 * hash + Objects.hashCode(this.api_sortno);
        return hash;
    }
