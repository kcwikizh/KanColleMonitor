...
public class Api_mst_shipupgrade {
    ...
    /**
     * @return the api_report_count
     */
    public int getApi_report_count() {
        return api_report_count;
    }

    /**
     * @param api_report_count the api_report_count to set
     */
    public void setApi_report_count(int api_report_count) {
