 ...
 */
package org.kcwiki.tools.swfunpacker.coredecryptor;
        ...
        final int taskID = corePool.getTaskNum();
            corePool.addTask(new Callable<Integer>() {
                ...
                try {
                    ...
                    ecryptMap(mapCode,org.kcwiki.initializer.MainServer.getMapid());
                    AnalyzeList.shipData();
                    new org.kcwiki.httpclient.DLThread().modifieddata(MainServer.getDownloadFolder()+File.separator+"Maps",ffpath, 1);
                    
                    while(!org.kcwiki.initializer.Start2DataThread.isHasStart2()){
                    ...
                    new org.kcwiki.httpclient.DLThread().modifieddata(MainServer.getDownloadFolder()+File.separator+"ShipVoice",ffpath, 2);
