            ...
            public void run() {
                ...
                try {
                    if(MainServer.isDebugMode()){
                        new org.kcwiki.monitor.start2.Start2Analyzer().ReadNewFile(null);
                    }else if(!org.kcwiki.monitor.start2.GetStart2.netStart()){
                        ...
                        new org.kcwiki.generator.wikilua.MakeNewShipData().WriteFile();
                        new org.kcwiki.generator.wikilua.MakeNewSlotitemData().WriteFile();
                        new org.kcwiki.httpclient.DLThread().start2();
