...
public class monitor {
    ...
    public String getData() {
      ...
      HashMap<String,String> hashList = MainServer.getNewHashMap();
      for(String id:hashList.keySet()) {
          this.addString("id: " + id + "\t hash: " + hashList.get(id));
      }
      this.addString("newHashListSize: " + hashList.size());
      
      if(org.kcwiki.cache.DBCenter.AddressList != null){
          org.kcwiki.cache.DBCenter.AddressList.keySet().forEach((_item) -> {
          this.addString("AddressList: "+_item+":\t"+org.kcwiki.cache.DBCenter.AddressList.get(_item));
        });
      }else{
          this.addString("AddressList:  null!");
      }
      this.addString("AddressList.size(): " + org.kcwiki.cache.DBCenter.AddressList.size());
